...
from Dataset.dataset_classification import data_zc,DatasetECG
import argparse
...
parser.add_argument('--direction',type=str,default='zc')
...
parser.add_argument('--mixfft',type=bool,default=True)
...
for seed in args.seed:
    ...
    path = 'Data/jndx/数据'
    train_data,train_label,val_data,val_label,test_data,test_label=data_zc(path,val=True)
    ...
    model = STClass(1,4,[2,2,2],args.dmodel,32,0.5,args.part).to(device)
